...
class SalesOrderLines(models.Model):
    ...
    line_item = fields.Integer(string="Line Item #",help="Shows the sequence of this line in the sale order.")


    _sql_constraints = [
        ('line_item_order_uniq', 'unique (line_item,order_id)', 'Line Item # must be unique per order!')
    ]
